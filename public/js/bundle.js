...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGVlcGFrc3RhcmsiLCJhIjoiY2thejNnY3FlMDl5NTMzcGoyOHEwNGhtZyJ9.c_3sJnZmEc8wbcRSDDdBBA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/deepakstark/ckaz5dfm828mt1imxsp1u1phx',
    scrollZoom: false // center: [-118.280622, 33.967217],
    // zoom: 4,
    // interactive: false
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updataSettings.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51GrLMuCvL1Jdd2TtJeBieYeLcVEQBozvi8SYGqZmTJa5oWhed1xN3bLQjk2KRqScEXp1h5C6tdBFZMFLKrvJ0bXl00RwL9mvOf');
...
var _updataSettings = require("./updataSettings");
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updataSettings.updateSettings)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updataSettings.updateSettings)({
